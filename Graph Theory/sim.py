...
# Run and visualize simulation with 3 firefighters
print("Simulation with 3 Firefighters:")
timesteps_3, protected_3 = simulate_firefighters(3, initial_infected)
print(f"Timesteps: {timesteps_3}, Protected Vertices: {protected_3}")

# Run and visualize simulation with 4 firefighters
print("Simulation with 4 Firefighters:")
timesteps_4, protected_4 = simulate_firefighters(4, initial_infected)
print(f"Timesteps: {timesteps_4}, Protected Vertices: {protected_4}")
